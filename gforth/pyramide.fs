...
\ draws all of it 
: pyramide 
efface_ecran valorise_hauteur_pyramide valorise_numero_ligne_a_0 valorise_nombre_de_blancs passe_a_la_ligne_suivante
BEGIN
	dessine_les_blancs dessinebordgauche calcul_nombre_d_etoiles_et_dessine_les_etoiles dessineborddroit
	incremente_numero_ligne decremente_nombre_de_blancs passe_a_la_ligne_suivante
	compare_nombre_de_linges_faites_avec_hauteur_pyramide 
> UNTIL
passe_a_la_ligne_suivante ;

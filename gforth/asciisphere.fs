...
;
: map-to-shade ( u -- u )   
	0 shade * 1000 /    1 max    0 shade min \ define where to shade 
;
: dot-light ( x y z -- i )      ( hard coded light vector z, y, x   )
	-770 *    rot 461 *    rot 461 *    + + 0 min 1000 / 
;
: intensity ( x y z -- u )  
	dot-light dup * 1000 /   map-to-shade \ define light 
;
: pixel ( x y r -- c )
